...
const Coin = ({
  ...
  return (
    <div className="cryptoCoin">
      ...
      <p className="coinPrice">Price: <span>{price} €</span></p>
      <p className="coinMarketcap">Market Cap: <span>{marketcap.toLocaleString()} €</span></p>
      <p className="coinVolume">Volume (24h): <span>{volume.toLocaleString()} €</span></p>
      {priceChange < 0 ? (
